...
async def setup_knowledge_base() -> str:
    ...
    if settings.mock_mode:
        print(f"✅ Mock Mode: Simulated creation of knowledge base '{settings.foundry_iq_knowledge_base_name}'")
    ...
    async with httpx.AsyncClient() as client:
        try:
            ...
            print(f"✅ Knowledge base '{kb_name}' created successfully with agentic retrieval enabled.")
            return kb_name
        except httpx.HTTPStatusError as e:
            print(f"❌ Failed to create knowledge base. Status code: {e.response.status_code}")
