...
class ReportSection(BaseModel):
    ...
    citations: List[str] = Field(description="List of Foundry IQ citations used in this section")
...
class ComplianceReport(BaseModel):
    ...
    executive_summary: str = Field(description="High-level summary for board/legal stakeholders")
    technical_findings: str = Field(description="Detailed technical breakdown for engineering")
    ...
    foundry_iq_citations_count: int = Field(description="Total number of citations used")
    is_verified: bool = Field(description="Whether the report passed the verification agent")
    verification_flags: List[str] = Field(description="List of flags raised by the verification agent")
    ...
    def example_data(cls) -> "ComplianceReport":
        return cls(
            ...
            is_verified=True,
            verification_flags=["Verification: Minor citation formatting fixed in section 2."]
        )
